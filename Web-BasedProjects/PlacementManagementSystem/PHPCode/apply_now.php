            ...
            <div class="top-news">
                <div class="top-inner">
                    ...
                    echo '
                        ...
                        echo '
                        <div class="col-md-12 top-text" style=" padding: 20px">
                            <h4>Enrolled Successfully</h4>
                        </div>';

                    if($error_fill_form == 0)
                        echo '
                        <div class="col-md-12 top-text" style="padding: 20px">
                            <h5 >you are applicable for Next Round</h5>
                        </div>';

                       echo ' <div class="col-md-12 top-text" style="padding: 20px">
                            <center><h3 style="padding-top: 20px">Your Resume</h3></center>
                    ...
                    while($row = mysqli_fetch_assoc($result)) { {
                        ...
                        echo '
                                    <div class="editor-pics">
                                        <div class="col-md-10 item-details" style="border: #ee82ee solid 1px; padding: 10px;margin: 10px">
